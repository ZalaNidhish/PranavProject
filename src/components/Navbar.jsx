...
const Navbar = () => {
  ...
  return (
    <div className='navbar w-screen h-30 flex items-center justify-center'>
      <div className='rounded-2xl border-1 border-gray-500 text-white px-8 py-4 flex gap-8 bg-[rgba(255,255,255,0.1)]'>
        ...
        <h1 className='text-[14px] bg-red-600 py-1 px-2 h-10 flex items-center rounded-lg font-semibold cursor-pointer hover:scale-90 duration-150'>Schedule a call</h1>
      </div>
    </div>
  )
}
